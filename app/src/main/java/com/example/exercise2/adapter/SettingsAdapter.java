...
public class SettingsAdapter extends BaseExpandableListAdapter {
    ...
    public SettingsAdapter(Context context, List<String> expandableListTitle, HashMap<String, List<String>> expandableListDetail) {
    ...
    public View getChildView(int listPosition, final int expandedListPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        TextView expandedListTextView = (TextView) convertView.findViewById(R.id.itemSettings);
    ...
    public int getChildrenCount(int listPosition) {
        ...
        return mExpandableListDetail.get(this.mExpandableListTitle.get(listPosition)).size();
    }
    ...
    public View getGroupView(int listPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = mLayoutInflater.inflate(R.layout.item_group_settings, null);
        }

        TextView listTitleTextView = (TextView) convertView.findViewById(R.id.itemGroupSettings);
